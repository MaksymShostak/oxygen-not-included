...
const SCOPE_ROUTING_INPUTS = [
  "scripts/selectPullRequestChecks.js",
  "scripts/runAffectedChecks.js",
  "tests/pr-check-scopes.test.js",
  "tests/oni-check-scopes.test.js",
  "tests/affected-checks.test.js",
];
const DOTNET_INPUTS = [
  "global.json", "NuGet.Config", "nuget.config",
  ":(glob)**/Directory.Build.*", ":(glob)**/Directory.Packages.props",
];
export const CHECK_INPUTS = {
  sdlc: [
    ...SCOPE_ROUTING_INPUTS,
    ".sdlc", ".codex", "AGENTS.md", "REVIEW.md", "docs/sdlc",
    ":(exclude).sdlc/runtime",
    ...
    "scripts/set_up_agent_skills.py", "scripts/set_up_mcp_servers.py",
    "scripts/setUpDevelopmentEnvironment.js", "tests/sdlc",
    "tests/set-up-development-environment.test.js", "tests/run-repository-python.test.js",
    "tests/sdlc-issue-acceptance.test.js", "tests/test_set_up_agent_skills.py",
