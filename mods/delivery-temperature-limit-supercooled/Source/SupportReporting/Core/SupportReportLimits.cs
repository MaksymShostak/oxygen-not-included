...
namespace DeliveryTemperatureLimit
{
    internal static class SupportReportLimits
    {
        ...
        internal const int MaximumExternalModIntegrations = 16;
        internal const int MaximumExternalModCapabilitiesPerIntegration = 16;
        internal const int MaximumExternalModDiagnosticsPerIntegration = 16;
